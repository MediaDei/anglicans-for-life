...
<section class="lead-life-ministry border-top border-bottom">
	<div class="leaders">
		...
		[dropcaps]A[/dropcaps][smallcaps] life leader[/smallcaps] is a person who works in partnership with Anglicans for Life within their church. He or she may be ordained or laity but must have a passion for upholding the sanctity of life.
		...
		[acc_content for_button="true"]
		[dropcaps]A[/dropcaps][smallcaps]Chapter[/smallcaps] is formed when a church has several people who are actively committed to promoting Life through ministry, education, and advocacy. A Chapter has a Chapter Leader, who serves as the link between the Chapter members and AFL.
		[/acc_content]
		[/accordion]');
		...
		[acc_content for_button="true"]
		[dropcaps]A[/dropcaps][smallcaps]chapter leader[/smallcaps] has the same minimum responsibilities as a Life Leader, but also holds one chapter event or gathering quarterly and regularly communicates with Chapter members.
		[/acc_content]
		[/accordion]'); 
		...
		[acc_button]I am interested. Where do I start?[/acc_button]
		[acc_content for_button="true"]
		[dropcaps]B[/dropcaps][smallcaps]efore registering[/smallcaps] to be a Chapter Leader, we encourage you to start with Prayer and Self-Evaluation. Pray for God’s guidance and discernment, seeking to understand the Lord’s call on your life. Ask yourself questions like: <em>How strong is my relationship with the Lord? Do I feel called by God to this ministry? How are my leadership skills? Do I have the time and emotional and spiritual energy for this commitment?</em>
